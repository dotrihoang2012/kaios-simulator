const fs = require('fs');
let js = fs.readFileSync('kaiosrt/gaia/profile/webapps/settings/js/panels/wifi_auth/panel.js', 'utf8');
...
if (js.match(regex)) {
    ...
    js = js.replace(methodRegex, methodStr);

    fs.writeFileSync('kaiosrt/gaia/profile/webapps/settings/js/panels/wifi_auth/panel.js', js);
    console.log('Success try-catch on kaiosrt panel.js');
} else {
