/* globals SIMSlotManager, WebActivity, LazyLoader, BaseModule, AppOrigin,
   SettingsObserver */
'use strict';
...
(function() {
  ...
  function EuRoamingManager(core) {
    this._connections =
      Array.prototype.slice.call(core.mobileConnections || []);
  ...
  BaseModule.create(EuRoamingManager, {
    ...
    _showNotification: function(serviceId) {
      ...
      var iconUrl =  `${AppOrigin.getOrigin('system')}/style/eu_roaming_manager/eu_roaming.png`;
      var options = {
