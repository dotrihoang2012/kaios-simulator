'use strict';
/* global SettingsObserver, Service */
...
(function(exports) {
  ...
  UsbStorage.prototype = {
    ...
    start: function() {
      ...
      SettingsObserver.observe(this.umsEnabled, false,
    ...
    stop: function() {
      ...
      SettingsObserver.unobserve(this.umsEnabled,
        this.bindUsbStorageChanged);
    },
    ...
    _getUsbProtocol: function() {
      SettingsObserver.getValue(this.usbTransferProtocol).then((value) => {
    ...
    _keyMigration: function(protocol) {
      if (protocol === undefined) {
        SettingsObserver.setValue([{
          name: this.usbTransferProtocol,
          value: this.protocolUMS
        }]);
