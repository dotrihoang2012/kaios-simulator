...
/* globals BluetoothTransfer, NDEFUtils,
           NDEF, NfcUtils, NotificationHelper, SettingsObserver */
...
var NfcHandoverManager = {
  ...
  _dispatchSendFileStatus: function _dispatchSendFileStatus(status, requestId) {
    ...
    if(navigator.b2g.nfc){
      navigator.b2g.nfc.notifySendFileStatus(status, requestId);
    }
  },
   ...
   * @memberof NfcHandoverManager.prototype
   */
  _onRequestConnect: function _onRequestConnect() {
    // TODO: implement nfc bluetooth connect dialog
  },
